    ...
    <div className="bg-black text-white min-h-screen overflow-x-hidden">
      ...
      <nav className={`fixed w-full z-50 transition-all duration-500 ${scrolled ? 'bg-black/95 backdrop-blur-xl border-b border-white/10 py-2 md:py-3' : 'bg-transparent py-3 md:py-5'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex justify-between items-center">
          <div className="flex items-center gap-2 md:gap-3 min-w-0">
            ...
            <span className="text-xl md:text-2xl font-bold tracking-tight bg-gradient-to-r from-white to-white/80 bg-clip-text text-transparent truncate">Zen Technologies</span>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="text-center lg:text-left">
              <div className="inline-flex items-center gap-2 bg-white/5 backdrop-blur-sm rounded-full px-3 sm:px-4 py-1.5 border border-white/10 mb-4 md:mb-6">
                ...
                <span className="text-xs sm:text-sm text-white/80">Ethiopian Tech Agency</span>
              </div>
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-4 md:mb-6 bg-gradient-to-b from-white to-white/70 bg-clip-text text-transparent">
                Digital Solutions <br className="hidden sm:block" />for Ethiopian Business
              </h1>
              <p className="text-base sm:text-lg md:text-xl text-white/60 mb-6 md:mb-8 max-w-lg mx-auto lg:mx-0">
              ...
              <div className="flex flex-wrap gap-3 md:gap-4 justify-center lg:justify-start">
                ...
                <button 
                  ...
                  className="border border-white/20 text-white px-6 sm:px-8 py-2.5 sm:py-3 rounded-full font-semibold text-sm sm:text-base lg:text-lg hover:bg-white/5 transition-colors"
                >
                  View Projects
                </button>
              </div>
            ...
            <div className="relative mt-8 lg:mt-0">
              ...
              <div className="absolute -top-6 -right-4 sm:-top-10 sm:-right-10 bg-black/60 backdrop-blur-md rounded-xl p-2 sm:p-3 border border-white/20 hidden sm:block">
              ...
              <div className="absolute -bottom-6 -left-4 sm:-bottom-10 sm:-left-10 bg-black/60 backdrop-blur-md rounded-xl p-2 sm:p-3 border border-white/20 hidden sm:block">
      ...
      <section className="py-10 md:py-16 border-y border-white/10 bg-black/40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <p className="text-center text-white/50 text-xs sm:text-sm uppercase tracking-wider mb-6 md:mb-8">Trusted by Ethiopian businesses</p>
          ...
          <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-6 md:gap-8">
            {clientLogos.map((logo, index) => (
              <div key={index} className="flex flex-col items-center gap-1 sm:gap-2 group cursor-pointer">
                ...
                <span className="text-white/40 text-[10px] sm:text-xs group-hover:text-white/80 transition">{logo.name}</span>
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 md:gap-8 mt-10 md:mt-16">
            {stats.map((stat, index) => (
              <div key={index} className="text-center">
                ...
                <div className="text-white/40 text-[10px] sm:text-xs md:text-sm">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="services" className="py-16 md:py-24 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 md:mb-4 bg-gradient-to-r from-white to-white/70 bg-clip-text text-transparent">Comprehensive Digital Solutions</h2>
            <p className="text-white/50 text-sm sm:text-base max-w-2xl mx-auto px-4">Everything you need to dominate your market, from restaurant POS to pharmaceutical traceability.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 md:gap-6">
            {services.map((service, i) => (
              <div key={i} className="group bg-white/[0.02] border border-white/10 rounded-2xl p-4 sm:p-5 md:p-6 hover:border-orange-500/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-xl hover:shadow-orange-500/10">
                <div className="w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 rounded-xl bg-orange-500/10 flex items-center justify-center mb-3 sm:mb-4 md:mb-5 group-hover:scale-110 transition-transform">
                  <service.icon className="text-orange-500" size={20} />
                </div>
                <h3 className="text-base sm:text-lg md:text-xl font-bold text-white mb-1 sm:mb-2">{service.title}</h3>
                <p className="text-white/50 text-xs sm:text-sm">{service.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="work" className="py-16 md:py-24 bg-black/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 md:mb-4 bg-gradient-to-r from-white to-white/70 bg-clip-text text-transparent">Featured Projects</h2>
            <p className="text-white/50 text-sm sm:text-base">Live systems deployed for Ethiopian businesses</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {projects.map((project, i) => (
              <div key={i} className="group rounded-2xl overflow-hidden bg-white/[0.02] border border-white/10 hover:border-orange-500/50 transition-all duration-500 flex flex-col">
                <div className="aspect-video overflow-hidden flex-shrink-0">
                  <img src={project.image} alt={project.title} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" />
                </div>
                <div className="p-4 sm:p-5 md:p-6 flex flex-col flex-grow">
                  <div className="flex flex-wrap gap-1.5 sm:gap-2 mb-2 sm:mb-3">
                    {project.tags.map(tag => <span key={tag} className="text-[10px] sm:text-xs px-2 py-0.5 sm:py-1 rounded-full bg-orange-500/10 text-orange-400">{tag}</span>)}
                  </div>
                  <h3 className="text-base sm:text-lg md:text-xl font-bold text-white mb-0.5 sm:mb-1">{project.title}</h3>
                  <p className="text-white/50 text-xs sm:text-sm mb-2 sm:mb-3 md:mb-4">{project.category}</p>
                  <p className="text-white/40 text-xs sm:text-sm mb-3 sm:mb-4 line-clamp-2 flex-grow">{project.description}</p>
                  <button 
                    onClick={() => window.open(project.liveLink, '_blank')}
                    className="text-orange-400 hover:text-orange-300 flex items-center gap-1 text-xs sm:text-sm transition-colors mt-auto"
                  >
      ...
      <section className="py-16 md:py-24 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid lg:grid-cols-2 gap-10 md:gap-16 items-center">
            <div>
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 md:mb-6 bg-gradient-to-r from-white to-white/70 bg-clip-text text-transparent">Why Ethiopian businesses choose Zen Technologies</h2>
              <p className="text-white/50 text-sm sm:text-base mb-6 md:mb-8">We understand local regulations, business needs, and deliver solutions that work in Ethiopia.</p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5 md:gap-6">
                {['EFDA Compliant', '24/7 Local Support', 'Clean Code', 'Scalable Systems'].map((feat, i) => (
                  <div key={i} className="flex gap-3 sm:gap-4 items-start">
                    <div className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 rounded-full bg-orange-500/10 flex items-center justify-center flex-shrink-0 text-orange-500 text-base sm:text-lg md:text-xl mt-0.5">✓</div>
                    <div><h3 className="font-bold text-white text-sm sm:text-base">{feat}</h3><p className="text-white/40 text-xs sm:text-sm">Enterprise-grade quality</p></div>
                  </div>
                ))}
              </div>
            </div>
            <div className="relative bg-white/[0.02] border border-white/10 rounded-2xl p-6 sm:p-8">
              <div className="space-y-4 sm:space-y-5 md:space-y-6">
                {['Discovery', 'Strategy', 'Design', 'Development', 'Launch', 'Support'].map((step, i) => (
                  <div key={step} className="flex items-center gap-3 sm:gap-4">
                    <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-orange-500/20 text-orange-500 flex items-center justify-center font-bold text-xs sm:text-sm">{i+1}</div>
      ...
      <section className="py-16 md:py-24 bg-black/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 md:mb-4 bg-gradient-to-r from-white to-white/70 bg-clip-text text-transparent">Trusted by Ethiopian industry leaders</h2>
            <p className="text-white/50 text-sm sm:text-base">What our clients say about their digital transformation</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {testimonials.map((t, i) => (
              <div key={i} className="bg-white/[0.02] border border-white/10 rounded-2xl p-5 sm:p-6 hover:border-orange-500/40 transition-all flex flex-col">
                <div className="flex gap-0.5 sm:gap-1 mb-3 sm:mb-4">
                  {[...Array(t.rating)].map((_, i) => <Star key={i} size={14} className="fill-orange-500 text-orange-500" />)}
                </div>
                <p className="text-white/80 text-sm sm:text-base mb-4 sm:mb-6 italic flex-grow">"{t.content}"</p>
                <div className="flex items-center gap-3 mt-auto">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="text-white/40 text-[10px] sm:text-xs truncate">{t.role}, {t.company}</div>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section id="pricing" className="py-16 md:py-24 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 md:mb-4 bg-gradient-to-r from-white to-white/70 bg-clip-text text-transparent">Invest in your digital future</h2>
            <p className="text-white/50 text-sm sm:text-base">Transparent pricing, customized for Ethiopian businesses</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-5xl mx-auto">
            <div className="bg-white/[0.02] border border-white/10 rounded-2xl p-6 sm:p-8 hover:-translate-y-2 transition-all">
              ...
              <p className="text-white/50 text-xs sm:text-sm mb-4 sm:mb-6">Perfect for new businesses & startups.</p>
              <button 
                onClick={() => window.open('https://t.me/anamyoha', '_blank')}
                className="w-full py-2.5 sm:py-3 rounded-full border border-white/20 text-white font-semibold text-sm sm:text-base hover:bg-white/5 transition-all"
              >
                Start Project
              </button>
            </div>
            <div className="relative bg-gradient-to-b from-orange-500/10 to-black border-orange-500/50 border rounded-2xl p-6 sm:p-8 hover:-translate-y-2 transition-all shadow-xl shadow-orange-500/10">
              ...
              <p className="text-white/50 text-xs sm:text-sm mb-4 sm:mb-6">For growing brands & restaurants.</p>
              <button 
                onClick={() => window.open('https://t.me/anamyoha', '_blank')}
            ...
            <div className="bg-white/[0.02] border border-white/10 rounded-2xl p-6 sm:p-8 hover:-translate-y-2 transition-all">
              ...
              <p className="text-white/50 text-xs sm:text-sm mb-4 sm:mb-6">Tailored solutions for large operations.</p>
              <button 
                onClick={() => window.open('https://t.me/anamyoha', '_blank')}
                className="w-full py-2.5 sm:py-3 rounded-full border border-white/20 text-white font-semibold text-sm sm:text-base hover:bg-white/5 transition-all"
              >
      ...
      <section className="py-16 md:py-24 bg-black/50">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-8 md:mb-12 bg-gradient-to-r from-white to-white/70 bg-clip-text text-transparent">Frequently Asked Questions</h2>
            ...
            {faqs.map((faq, i) => (
              <div key={i} className="border border-white/10 rounded-2xl overflow-hidden">
                ...
                <div className={`px-4 sm:px-5 md:px-6 overflow-hidden transition-all duration-500 ${openFaq === i ? 'max-h-40 pb-4 sm:pb-5 md:pb-6' : 'max-h-0'}`}>
                  <p className="text-white/50 text-sm sm:text-base">{faq.a}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-16 md:py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center relative z-10">
          ...
          <p className="text-white/60 text-base sm:text-lg md:text-xl max-w-2xl mx-auto mb-6 md:mb-10 px-4">Let's build your digital solution together.</p>
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4">
            ...
            <button 
              ...
              className="border border-white/20 text-white px-5 sm:px-6 md:px-8 py-3 sm:py-3.5 md:py-4 rounded-full font-bold text-sm sm:text-base md:text-lg flex items-center gap-2 hover:bg-white/5 transition-all"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4">
            <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3">
              ...
              <span className="text-white/40 text-[10px] sm:text-xs">© 2025 Ethiopia. All rights reserved.</span>
            </div>
            <div className="flex gap-4 sm:gap-6">
              <a href="https://www.instagram.com/anamyoha" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-orange-400 transition-colors text-xs sm:text-sm">Instagram</a>
              <a href="https://www.linkedin.com/in/amanuel-yohannes-2453981aa/" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-orange-400 transition-colors text-xs sm:text-sm">LinkedIn</a>
              <a href="https://t.me/anamyoha" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-orange-400 transition-colors text-xs sm:text-sm">Telegram</a>
            </div>
          </div>
        </div>
      </footer>
